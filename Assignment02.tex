...
%---------------------------------------------%
%--------------Citing Reference---------------%
%\cite{shi2006political,hellwig2012constructing}.
%\citeA{}
%\cite<e.g.,>{duch2013voter,shi2006political}.
%--------------Citing Reference---------------%

%--------To format text like italic, bold-----%
%\textit %--to make italic text--%
%\textsc %--to make CAPITAL text--%
%--------To format text like italic, bold-----%

%\includepdf{pdf.pdf} (to include pdf!)

%for line break \vspace{4mm} or \\* or just press enter

%\usepackage[T1]{fontenc} %for another font in the body,
%\usepackage[bitstream-charter]{mathdesign} different font

%include "hidelinks" if I want to remove the round line %around reference%
%---------------------------------------------%
%%%%%%%----------NOTES ENDS-------------%%%%%%%
%---------------------------------------------%
